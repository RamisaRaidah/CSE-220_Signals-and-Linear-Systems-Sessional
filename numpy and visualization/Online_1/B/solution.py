...
def stem_plot(ax, n, x, labels):
    """A nicer stem plot for discrete-time sequences."""
    markerline, stemlines, baseline = ax.stem(n, x, label=labels)
...
def main():
    ...
    phi0 = np.pi/6  # an arbitrary phase change
